...
# MongoDB connection
client = MongoClient('mongodb+srv://harshbanka:bXWEYnySHsIUkF3Y@news-bug.pk49d.mongodb.net/disease-data?retryWrites=true&w=majority&appName=news-bug')
...
def crawl_and_extract(start_url, platform, max_pages=20, max_depth=2, domain=None, max_workers=5):
    """
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        while to_visit and len(articles) < max_pages:
            ...
            while to_visit and to_visit[0][1] == current_depth and len(current_batch) < max_workers:
...
if __name__ == "__main__":
    ...
    platform = "CNN"
    articles = crawl_and_extract(start_url, platform, max_pages=20, max_depth=2, max_workers=5)
